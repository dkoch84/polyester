...
export const COMPONENTS: ComponentDef[] = [
  // ======== Layout Components ========
  {
    ...
    flags: [
      ...
      { name: "width", description: "Paper width for pageless PDF output (px, pt, mm, cm or in). Paginated documents take their width from the page size.", hasValue: true, default: "794px" },
